...
from models.fusion.film_fusion import FiLMFusionBlock
from models.fusion.film_fusion import SymmetricalFiLMFusionBlock
...
class FusionTrainer(nn.Module, dataProcessor):
    ...
    def _build_model(self):
        ...
        self.fusion_block = SymmetricalFiLMFusionBlock(
            feature_dim=self.cfg.hidden,
            post_fusion_dim=self.cfg.hidden
        )          
    ...
    def forward(self, batch):
        ...
        # Fusion Block 통과
        fused_feat = self.fusion_block(motion_feat, emotion_feat)  # (B, T, H)
