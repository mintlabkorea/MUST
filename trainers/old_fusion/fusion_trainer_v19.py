"""
v18 기반, Hard freeze + Bi-directional FiLM + Causal Context Stream 분리
제안 1 (양방향 FiLM)과 제안 2 (인과적 컨텍스트 스트림 분리)를 모두 적용한 버전입니다.
"""
import torch
...
class FusionTrainer(nn.Module, dataProcessor):
    ...
    def _build_model(self):
        print("\n--- Building V19 model architecture: Bi-directional FiLM + Causal Context ---")
    ...
    def _create_optimizer(self):
        ...
        params_to_train += [
            ...
            self.mot_film.parameters(), # 신규 mot_film 추가 ★
        ]
    ...
    def run_epoch(self, loader, train: bool):
        ...
        for batch in loader:
            with torch.set_grad_enabled(train):
                ...
                loss_cross = (1 - F.cosine_similarity(out['fused_motion'], out['fused_emotion'], dim=1)).mean()
    ...
    def fusion_train(self):
        ...
        for epoch in range(1, self.cfg.MainTask.epochs + 1):
            ...
            if va_loss < best_loss:
                ...
                }, "weights/best_fusion_v19.pt") # Updated save path
            else:
                patience_counter += 1
        ...
        print(f"\n--- Best Validation Performance (v19) ---")
